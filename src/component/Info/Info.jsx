  ...
  return (
         ...
         <div className="information-container">
             ...
             <div className="basic-stats">
                <h2>Hp <span style={{marginLeft:'135px'}}>:</span> {pokemonHp} </h2>
                <h2>Attack <span style={{marginLeft: '99px'}}>:</span> {pokemonAttack}</h2>
                <h2>Defense <span style={{marginLeft: '89px'}}>:</span> {pokemonDefense}</h2>
                <h2>Special-Attack <span style={{marginLeft: '19px'}}>:</span> {pokemonSpecialAttack}</h2>
                <h2>Special-Defense <span style={{marginLeft: '9px'}}>:</span> {pokemonSpecialDefense}</h2>
                <h2>Speed<span style={{marginLeft: '116px'}}>:</span> {pokemonSpeed}</h2>
             </div>
         </div>      
     </div>
  )
